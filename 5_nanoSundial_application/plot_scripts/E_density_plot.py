...
# merged_positive_site_gene_expand.bed is the center site of positive region and annotated by gene.bed on CDS region.
# Then expand 100bps both of start and end.
df = pd.read_csv('merged_positive_site_gene_expand.bed', sep='\t',header=None)
df = df[df[12]=='mRNA']
